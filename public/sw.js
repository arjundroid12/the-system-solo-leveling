// Solo Leveling System — Service Worker v12
const CACHE_NAME = 'solo-leveling-system-v12'
...
self.addEventListener('fetch', (event) => {
  ...
  // Never intercept build assets — Next serves them content-hashed with
  // immutable cache headers; SW caching them only creates stale-bundle bugs.
