// Solo Leveling System — Service Worker v13
const CACHE_NAME = 'solo-leveling-system-v13'
...
self.addEventListener('fetch', (event) => {
  ...
  // Never intercept build assets (content-hashed + immutable) or API calls —
  // cache-firsting an API GET freezes it at its first-ever response.
